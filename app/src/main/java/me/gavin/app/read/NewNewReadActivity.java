...
import me.gavin.text.databinding.ActivityReadNewNewBinding;

public class NewNewReadActivity extends BindingActivity<ActivityReadNewNewBinding> {
    ...
    protected int getLayoutId() {
        return R.layout.activity_read_new_new;
    }
